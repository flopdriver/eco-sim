...
import { BiologySystem } from '../biology/biology-system.js';
import { WebGLRenderingSystem } from '../rendering/webgl-renderer-interface.js';
import { UserInteractionSystem } from '../user-interaction/user-interaction-system.js';
import { ColorMapper } from '../rendering/color-mapper.js';
...
export const SystemManager = {
    ...
    initializeSystems: function(canvasId) {
        ...
        if (ColorMapper) {
            ColorMapper.TYPE = this.controller.TYPE;
            ColorMapper.STATE = this.controller.STATE;
            ColorMapper.core = this.controller.core;
        }
