...
export const UIManager = {
    ...
    setupPhysicsControls: function() {
        ...
        this.setupSlider('gravity-slider', 'gravity-value', (value) => {
            ...
            if (this.controller.physics && this.controller.physics.gravitySystem) {
        ...
        this.setupSlider('water-flow-slider', 'water-flow-value', (value) => {
            const rate = value / 100;
            if (this.controller.physics && this.controller.physics.fluidDynamicsSystem) {
                this.controller.physics.fluidDynamicsSystem.waterFlowRate = rate;
            } else {
                console.warn("Fluid dynamics system not found on physics controller!");
            }
            return rate.toFixed(1);
        });
        ...
        this.setupSlider('air-flow-slider', 'air-flow-value', (value) => {
            const rate = value / 100;
            if (this.controller.physics && this.controller.physics.airDynamicsSystem) {
                this.controller.physics.airDynamicsSystem.airFlowRate = rate;
            }
            return rate.toFixed(1);
        });
        ...
        this.setupSlider('erosion-slider', 'erosion-value', (value) => {
            const strength = value / 100;
            if (this.controller.physics && this.controller.physics.erosionSystem) {
