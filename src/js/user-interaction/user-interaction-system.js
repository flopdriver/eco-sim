...
import { EventHandlerSystem } from './event-handler-system.js';
import { VisualizationSystem } from './visualization-system.js';
// Import WebGLRenderingSystem for coordinate calculation (if needed)
import { WebGLRenderingSystem } from '../rendering/webgl-renderer-interface.js'; 

export const UserInteractionSystem = {
    ...
    getSimCoordinates: function(event) {
        ...
        if (WebGLRenderingSystem && WebGLRenderingSystem.rendererCore && 
            WebGLRenderingSystem.rendererCore.baseWidth) {
